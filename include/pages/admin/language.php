<div class="container">
    <div class="row">
        <a href="<?php echo $App->getWebsite(); ?>/admin/language_form.html"><div class="btn btn-default btn-submit btn-new">New</div></a>
    </div>
    <div class="row">
...
<script>
    ...
    function drawTable(){
        ...
        $("#myTable").dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo $App->getWebsite(); ?>/admin/language.html",
            "oLanguage":{
            ...
            "aoColumns":
                [
                    ...
                    {"mDataProp": "iso", "bSortable": false},
                    {"mDataProp": "created_at", "bSortable": false},
                    {"mDataProp": "id",  "bSortable": false,
                        "fnRender": function(obj) {
                            return '<a class="blue" href="<?php echo $App->getWebsite(); ?>/admin/language_form.html?id='+obj.aData.id+'"><span class="glyphicon glyphicon-edit"></span></a>' +
                                ' <a class="blue" href="<?php echo $App->getWebsite(); ?>/admin/language_delete?id='+obj.aData.id+'"><span class="glyphicon glyphicon-remove"></span></a>';
                        }}
                ],
